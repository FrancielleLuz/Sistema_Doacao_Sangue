        ...
        <div class="table-wrapper">
           ...
           <!-- Inicio  - Informações Top da tela -->
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                	<?php 
                	 include("tipotelefone_select.php");
                    ...
                    <tr class="trCad">
                        ...
                        <td width="30%" id="codTelefone"><?php echo $value['codigo']; ?></td>
                        <td width="60%" id="nomeTelefone"><?php echo $value['nome']; ?></td>
                    </tr>               
                    <?php } ?>
                </tbody>
            </table>
			...
			<div class="modal-content">
				<form>
					<div class="modal-header">						
						<h4 class="modal-title">Adicionar tipo de telefone</h4>
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					</div>
					<div class="modal-body">			
						<div class="form-group">
							<label for="salvando_nome-tipo-telefone">Descrição</label>
							<input id="salvando_nome-tipo-telefone" type="text" class="form-control" required>
						</div>					
					</div>
	...
	<div id="editEmployeeModal" class="modal fade">
		<div class="modal-dialog">
			<div class="modal-content">
				<form>
					<div class="modal-header">						
						<h4 class="modal-title">Editar tipo de telefone</h4>
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					</div>
					<div class="modal-body">
						<input type="hidden" name="update_codigo" id="update_codigo">		
						<div class="form-group">
							<label for="editando_nome-tipo-telefone">Descrição</label>
...
$(document).ready(function(){
	...
	$("#salvar_cadastro").on('click', function(){
        $.ajax({
            url:'tipotelefone_insert.php',
            type:'POST', 
            data:{
                 nome:$("#salvando_nome-tipo-telefone").val() 
            },
