    ...
    <div class="container">
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody id="myTable">
                    <?php 
                	 include("BDO/doenca/doenca_pet_select.php");
                    ...
                    <tr class="trCad">
                        ...
                        <td width="65%"><?php echo $value['descricao']; ?></td>
                    </tr>
                    <?php } ?>
                </tbody>
            </table>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#alterar_cadastro").on('click', function() {
                $.ajax({
                    url: 'BDO/doenca/doenca_update.php',
                    type: 'POST',
                    data: {
            ...
            $("#salvar_cadastro").on('click', function() {
                $.ajax({
                    url: 'BDO/doenca/doenca_insert.php',
                    type: 'POST',
                    data: {
            ...
            $("#deletar_cadastro").on('click', function() {
                $.ajax({
                    url: 'BDO/doenca/doenca_delete.php',
                    type: 'POST',
                    data: {
