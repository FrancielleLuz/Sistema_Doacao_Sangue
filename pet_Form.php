<?php
include("BDO/pet/pet_especie_select.php");
include("BDO/pet/pet_tipoSanguineo_select.php");
include("BDO/pet/pet_raca_select.php");
include("BDO/pet/pet_tutor_select.php");
?>
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody id="myTable">
                    ...
                    <tr class="trCad">
                        ...
                        <td width="30%"><a href="pet_Comp_Form-Copia.php?id=<?php echo $value['codigo']; ?>"><?php echo $value['nome']; ?></a></td>
                        <td width="10%"><?php echo $value['dtNascimento']; ?></td>
                        <td width="10%"><?php echo $value['sexo']; ?></td>
                        <td width="10%"><?php echo $value['doador']; ?></td>
                        <td width="10%"><?php echo $value['especie']; ?></td>
                        <td width="10%"><?php echo $value['tipoSanguineo']; ?></td>
                    </tr>
                    <?php } ?>
                </tbody>
            </table>
                ...
                <form>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input id="update_dtFalecimento" type="text" class="form-control" required>
                            <label>Sexo</label>
                            <select id="update_sexo" class="form-control" required>
                                <option></option>
                                <option value="Fêmea">Fêmea</option>
                                <option value="Macho">Macho</option>
                            </select>
                            ...
                            <label>Doador</label>
                            <select id="update_doador" class="form-control" required>
                                <option></option>
                                <option value="Sim">Sim</option>
                                <option value="Não">Não</option>
                            </select>
                            <label>Comportamento</label>
                            <input id="update_comportamento" type="text" class="form-control" required>
                            ...
                            <label>Raça</label>
                            <select id="update_raca" class="form-control" required>
                                <option></option>
                                <?php foreach ($arrCombo3 as $value) { ?>
                                <option value="<?php echo $value['codigo']; ?>"><?php echo $value['nome']; ?></option>
                                <?php } ?>
                            ...
                            <label>Tutor</label>
                            <select id="update_tutor" class="form-control" required>
                                <option></option>
                                <?php foreach ($arrCombo4 as $value) { ?>
                                <option value="<?php echo $value['codigo']; ?>"><?php echo $value['nome']; ?></option>
                                <?php } ?>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('.editbtn').on('click', function() {
                ...
                $.ajax({
                    url: 'BDO/pet/pet_selectConsulta2.php',
                    type: 'POST',
                    data: {
                        codigo: resultado[1]
                    },
