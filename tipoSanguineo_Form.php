    ...
    <div class="container">
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody id="myTable">
                    <?php 
                	 include("BDO/tipoSanguineo/tipoSanguineo_select.php");
                    ...
                    <tr class="trCad">
                        ...
                        <td width="90%"><?php echo $value['nome']; ?></td>
                    </tr>
                    <?php } ?>
                </tbody>
            </table>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $("#alterar_cadastro").on('click', function() {
                $.ajax({
                    url: 'BDO/tipoSanguineo/tipoSanguineo_update.php',
                    type: 'POST',
                    data: {
            ...
            $("#salvar_cadastro").on('click', function() {
                $.ajax({
                    url: 'BDO/tipoSanguineo/tipoSanguineo_insert.php',
                    type: 'POST',
                    data: {
            ...
            $("#deletar_cadastro").on('click', function() {
                $.ajax({
                    url: 'BDO/tipoSanguineo/tipoSanguineo_delete.php',
                    type: 'POST',
                    data: {
