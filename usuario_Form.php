                    ...
                    <div class="modal-body">
                        <div class="form-group">
							...
							<div class="form-group">
								...
								<select class="form-control" id="salvando_perfil" name="fk_perfil" required>
                ...
                <form>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
							...
							<div class="form-group">
								<label for="perfil">Perfil</label>
								<select class="form-control" id="update_perfil" name="fk_perfil" required>
									<option value="">Selecione um perfil</option>
								</select>
							</div>
							<label for="situacao">Situação:</label>
...
?>
    ...
    $(document).ready(function() {
        ...
        function carregarPerfis() {
            $.ajax({
                url: 'BDO/usuario_perfil/usuario_perfil_select.php',
                type: 'GET',
                dataType: 'json',
                success: function(data) {
                    var options = '<option value="">Selecione um perfil</option>';
                    for (var i = 0; i < data.length; i++) {
                        options += '<option value="' + data[i].codigo + '">' + data[i].nome + '</option>';
                    }
                    // Carrega nos dois selects
                    $('#salvando_perfil, #update_perfil').html(options);
                },
                error: function() {
        ...
        $('.editbtn').on('click', function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#update_perfil').val(obj[0].fk_perfil); // adiciona o perfil
                },
                error: function(data) {
